...
function promiseAjx(checkProd){
    ...
    $.ajax({
        ...
        success: function(data) {
			...
			dataServiceData = myObject
			dataServiceMiniData = data
	   ...
	   $.ajax({
        ...
        success: function(data) {
			...
			if(preProdMode=="true" || preProdMode==true){alert("foo");promiseAjx(urlPreprod);dataServiceUrl=urlPreprod}
			else{promiseAjx(urlBase);dataServiceUrl=urlBase}
