...
(function(){
    ...
    function ResultsController(quizMetrics, DataService){
        ...
        function calculatePerc(){
			...
			if(redingo>DataService.quizQuestions.length){redingo=DataService.quizQuestions.length};var mujo =redingo / DataService.quizQuestions.length * 100;
			localStorage.setItem('masterScore',mujo);if(mujo>100){mujo=100};
        ...
        function getAnswerClass(index){
             ...
             */
            if(index+1 === quizMetrics.correctAnswers[vm.activeQuestion]){
                return "bg-success";
