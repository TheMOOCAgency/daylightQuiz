...
function trueForce(){
	$.ajax({
            url: 'http://51.75.207.43:3000/quizMaster3',
            type: 'GET',
            dataType: 'html',
 ...
 $.ajax({
                ...
                for (var i = 0; i < listShuffle.length; i++) {
                    quizQuestions.push(

                        {
                            ...
                            possibilities: [{
                                    answer: qArray[listShuffle[0]].possibilities[0],
                                },
                                {
                                    answer: qArray[listShuffle[0]].possibilities[1],
                                },
                                {
                                    answer: qArray[listShuffle[0]].possibilities[2],
                                },
                                {
                                    answer: qArray[listShuffle[0]].possibilities[3],
                                }
    ...
    loadAnswers=function(){    $.ajax({
            ...
            success: function(data) {
                ...
                var x = JSON.parse(cosy);  
				qArray = x.quiz1a
				var compose ="answer_array"+quizID
				bArray = x[compose]
				console.log(bArray)
